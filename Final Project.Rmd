...
#mean(preds==test_cv$price)
preds_final = predict(model, newdata=test, type = "class")
#sub$price = preds_final
write.csv(preds_final, file = "C:\\Users\\admin\\Desktop\\Course Work\\STAT 388\\Final Project\\AirBnB\\finalpredictions.csv", row.names = FALSE)
```